                  ...
                  itemBuilder: (BuildContext context,int  index) {
                    return
                       ListTile(
                        ...
                        subtitle: Text("${snapshot.data![index].artist}",style:const TextStyle(fontSize: 11),),
                        ...
                        onTap: () {
                         ...
                         Get.find<PlayerController>().updateSelectedSong(snapshot.data![index]);
                         Get.to(()=> SongPage(data: snapshot.data!),transition: Transition.fadeIn);
